...
public class Prjava43lopezR24 extends Frame 
   ...
   public Prjava43lopezR24 () { 
      ...
      setTitle("nova finestra prjava43LopezR24");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43lopezR24();  // Let the construct do the job 
   } 
